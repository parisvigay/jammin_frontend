  ...
  return (
    <div className="navContainer">
      ...
      <nav className="navBar" id="nav">
        ...
        { !loggedIn ?(
          <> 
            <Link className={pathname === '/signup' ? 'activeLink' : ''} id="link" style={{ textDecoration: 'none' }} to="/signup">Sign Up</Link> 
            <Link className={pathname === '/login' ? 'activeLink' : ''} id="link" style={{ textDecoration: 'none' }} to="/login">Log In</Link>
          </> 
      ) : (
        <>
          <Link className={pathname === '/my-bands' || pathname === '/my-bands/create' ? 'activeLink' : ''} id="link" style={{ textDecoration: 'none' }} to="/my-bands">My Bands</Link> 
